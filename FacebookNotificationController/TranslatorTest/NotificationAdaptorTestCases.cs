...
namespace TranslatorTest
{
    public class NotificationAdaptorTestCases
    {
        ...
        #region
        {
            ...
            mockNotificationhandlerObject.Setup(handler => handler.InsertNotification(It.IsAny<Model.Notification>())).Returns(Task.FromResult(true));

            NotificationHandler notificationAdaptorRepository = new NotificationHandler(mockNotificationhandlerObject.Object);
            var result = notificationAdaptorRepository.SendNotification(notification);
        ...
        #region
        {
            ...
            Mock<INotificationManager> mockNotificationhandlerObject = new Mock<INotificationManager>();
            mockNotificationhandlerObject.Setup(handler => handler.GetNotification(It.IsAny<string>())).Returns(Task.FromResult(new List<Model.Notification> {
        ...
        #region
        {
            ...
            mockNotificationManager.Setup(manage => manage.GetUnreadNotificationCount(It.IsAny<string>())).Returns(Task.FromResult(1));
        ...
        {
            Mock<INotificationManager> mockNotificationManager = new Mock<INotificationManager>();
            mockNotificationManager.Setup(manage => manage.GetUnreadNotificationCount(It.IsAny<string>())).Returns(Task.FromResult(0));
