...
namespace TranslatorTest
{
    public class BussinessLogicTestCases
    {
        ...
        #region
        {
            ...
            var result = notificationHandler.InsertNotification(notification);
        ...
        #region
        {
            ...
            NotificationManager notificationHandler = new NotificationManager(mockNotificationStoreObject.Object);
            var result = notificationHandler.GetNotification("chaitali");
        ...
        #region
        {
            ...
            var result =notificationManager.GetUnreadNotificationCount("Ritu");
