...
namespace TranslatorTest
{
    public class ServiceLayerTestCases
    {
        ...
        #region
        {
            ...
            mockNotificationAdaptorObject.Setup(request => request.SendNotification(notification)).Returns(Task.FromResult(true));
        ...
        #region
        {
            ...
            mockNotificationHandler.Setup(handler => handler.GetUnreadNotificationCount(It.IsAny<string>())).Returns(Task.FromResult(2));
        ...
        {
            Mock<INotificationManager> mockNotificationHandler = new Mock<INotificationManager>();
            mockNotificationHandler.Setup(handler => handler.GetUnreadNotificationCount(It.IsAny<string>())).Returns(Task.FromResult(0));
